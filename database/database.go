...
type Database interface {
	...
	// GetNodeIndexVersion gets the IndexVersion last built by the node.
	//
	// Note that this is a variable stored by the node to rebuild the index if it
	// ever does not match the expected version.
	GetNodeIndexVersion() (string, error)

	//SetNodeIndexVersion sets the IndexVersion last built by the node.
	//
	// Note that this is a variable stored by the node to rebuild the index if it
	// ever does not match the expected version.
	SetNodeIndexVersion(string) error

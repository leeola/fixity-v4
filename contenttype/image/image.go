...
func (t *Image) StoreContent(rc io.ReadCloser, v ct.Version, c ct.Changes) ([]string, error) {
...
func (t *Image) StoreMeta(v ct.Version, c ct.Changes) ([]string, error) {
	var meta Meta
...
func (Image) UnmarshalMeta(b []byte) (interface{}, error) {
	var meta Meta
